...
export const KEYCLOAK_URL_GET_TOKEN =
  KEYCLOAK_HOST_URL + '/realms/{realm_name}/protocol/openid-connect/token';
export const KEYCLOAK_USER_URL =
  KEYCLOAK_HOST_URL + '/admin/realms/{realm_name}/users';
export const KEYCLOAK_GET_GROUPS_REALM_LEVEL_ROLES =
  KEYCLOAK_HOST_URL +
  '/admin/realms/' +
  KEYCLOAK_REALM +
  '/groups/{GROUP_ID_FROM_API}/role-mappings/realm';
export const KEYCLOAK_GET_ALL_GROUPS =
  KEYCLOAK_HOST_URL + '/admin/realms/{realm_name}/groups';

export const KEYCLOAK_GET_GROUP_ROLES =
  KEYCLOAK_HOST_URL +
  '/admin/realms/' +
  KEYCLOAK_REALM +
  '/groups/{GROUP_ID}/role-mappings';

export const KEYCLOAK_DEFAULT_USER_GROUP = 'Users Group';
